...
static const NSInteger kMaxContainerCapacity = 850;
...
- (void)drawCurve
{
	...
	CGContextSetStrokeColorWithColor(UIGraphicsGetCurrentContext(), [UIColor colorWithRed:170.0/255 green:103.0/255 blue:49.0/255 alpha:1.0].CGColor);
